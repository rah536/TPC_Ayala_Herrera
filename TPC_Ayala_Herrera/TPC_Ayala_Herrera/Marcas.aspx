...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="card text-center">
        <div class="card-header bg-transparent">
            <div>
                <img src="img/marca-categoria.png" alt="logoMarca" height="100" width="130" /><br />
        ...
        <div class="card-body col-6 m-auto">
            <div>
                ...
                <asp:Button ID="btnFiltro" runat="server" OnClick="btnFiltro_Click" CssClass="btn btn-secondary" Text="Buscar"  />
